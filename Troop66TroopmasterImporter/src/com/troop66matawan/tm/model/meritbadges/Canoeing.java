...
class  Canoeing  extends PartialMeritBadge {
1 Do the following:
...
2 Before doing the following requirements, successfully complete the <a href="/wiki/index.php/BSA_Swim_Test" class="mw-redirect" title="BSA Swim Test">BSA swimmer test</a>: Jump feetfirst into water over the head in depth. Level off and swim 75 yards in a strong manner using one or more of the following strokes: sidestroke, breaststroke, trudgen, or crawl; then swim 25 yards using an easy, resting backstroke. The 100 yards must be completed in one swim without stops and must include at least one sharp turn. After completing the swim, rest by floating.
3 Do the following:
