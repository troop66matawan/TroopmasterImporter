...
class  Space_Exploration  extends PartialMeritBadge {
...
3 Build, launch, and recover a model rocket.<sup id="cite_ref-0" class="reference"><a href="#cite_note-0" title>[1]</a></sup> Make a second launch to accomplish a specific objective. (Rocket must be built to meet the safety code of the National Association of Rocketry. See the "Model Rocketry" chapter of the <i>Space Exploration</i> merit badge pamphlet.) Identify and explain the following rocket parts:
	a. Body tube
	b. Engine mount
	c. Fins
	d. Igniter
