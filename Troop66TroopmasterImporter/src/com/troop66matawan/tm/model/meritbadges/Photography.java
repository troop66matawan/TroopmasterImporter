...
class  Photography  extends PartialMeritBadge {
...
2Explain how the following elements and terms can affect the quality of a picture:
...
3Explain the basic parts and operation of a camera. Explain how an exposure is made when you take a picture.
4Do TWO of the following, then share your work with your counselor.
...
5Photograph THREE of the following, then share your work your counselor.
...
6Describe how software allows you to enhance your photograph after it is taken. Select a photo you have taken, then do ONE of the following, and share what you have done with your counselor.
...
7Using images other than those created for requirements 4, 5 or 6, produce a visual story to document an event to photograph OR choose a topic that interests you to photograph. Do the following:
...
8Identify three career opportunities in photography. Pick one and explain to your counselor how to prepare for such a career. Discuss what education and training are required, and why this profession might interest you.
