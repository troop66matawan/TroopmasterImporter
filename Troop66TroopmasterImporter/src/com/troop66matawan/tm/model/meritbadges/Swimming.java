...
class  Swimming  extends PartialMeritBadge {
1 Do the following:
	a. Explain to your counselor how Scouting’s <a href="/wiki/index.php/Safe_Swim_Defense" title="Safe Swim Defense">Safe Swim Defense</a> plan anticipates, helps prevent and mitigate, and provides responses to likely hazards you may encounter during swimming activities.
...
2 Before doing the following requirements, successfully complete the <a href="/wiki/index.php/BSA_swimmer_test" title="BSA swimmer test">BSA swimmer test</a>: Jump feet first into water over the head in depth. Level off and swim 75 yards in a strong manner using one or more of the following strokes: sidestroke, breaststroke, trudgen, or crawl; then swim 25 yards using an easy, resting backstroke. The 100 yards must be completed in one swim without stops and must include at least one sharp turn. After completing the swim, rest by floating.
...
7 Following the guidelines set in the BSA Safe Swim Defense, in water at least 7 feet deep*, show a standing headfirst dive from a dock or pool deck. Show a long shallow dive, also from the dock or pool deck.
	 *<i>If your state, city, or local community requires a water depth greater than 7 feet, it is important to abide by that mandate.</i>
