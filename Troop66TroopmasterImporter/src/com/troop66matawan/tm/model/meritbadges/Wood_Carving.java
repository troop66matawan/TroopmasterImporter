...
class  Wood_Carving  extends PartialMeritBadge {
1 Do the following:
	...
	b. Show that you know first aid for injuries that could occur while wood carving, including <a href="/wiki/index.php/Minor_cuts" class="mw-redirect" title="Minor cuts">minor cuts</a> and <a href="/wiki/index.php/Scratches" class="mw-redirect" title="Scratches">scratches</a> and <a href="/wiki/index.php/Splinters" class="mw-redirect" title="Splinters">splinters</a>.
	
2 Do the following:
	a. Earn the <a href="/wiki/index.php/Totin%27_Chip" title="Totin' Chip">Totin' Chip</a> recognition.
...
6 Plan your own or select a project from this (the <i>Wood Carving</i>) merit badge pamphlet and complete a simple carving in the round.
