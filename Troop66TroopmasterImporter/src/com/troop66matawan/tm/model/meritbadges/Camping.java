...
class  Camping  extends PartialMeritBadge {
1Do the following:
...
2Learn the <a href="/wiki/index.php/Leave_No_Trace" title="Leave No Trace">Leave No Trace</a> principles and the <a href="/wiki/index.php/Outdoor_Code" title="Outdoor Code">Outdoor Code</a> and explain what they mean. Write a personal plan for implementing these principles on your next outing..
3Make a written plan for an overnight trek and show how to get to your camping spot using a topographical map and compass OR a topographical map and a GPS receiver. If no GPS receiver unit is available, explain how to use one to get to your camping spot.
4Do the following:
	a. Make a duty roster showing how your <a href="/wiki/index.php/Patrol" title="Patrol">patrol</a> is organized for an actual overnight campout. List assignments for each member.
	b. Help a Scout patrol or a <a href="/wiki/index.php/Webelos" class="mw-redirect" title="Webelos">Webelos</a> Scout unit in your area prepare for an actual campout, including creating the duty roster, menu planning, equipment needs, general planning, and setting up camp.
...
7Prepare for an overnight campout with your patrol by doing the following:
...
9Show experience in camping by doing the following:
	...
	1. Hike up a mountain where, at some point, you are at least 1,000 feet higher in elevation from where you started. **
	 <i>**The wording in the merit badge pamphlet (as shown above) is different than the wording in Boy Scout Requirements 2017, which reads: "Hike up a mountain, gaining at least 1,000 vertical feet."</i>
	...
	c. Perform a conservation project approved by the landowner or land managing agency. This can be done alone or with others.***
	 <i>***The wording in the merit badge pamphlet (as shown above) is different than the wording in Boy Scout Requirements 2017, which omits the last sentence. The 2016 edition of Boy Scout Requirements included a footnote reading: "The Scout may choose to do requirement 9c alone or with others."</i>
	
10Discuss how the things you did to earn this badge have taught you about personal health and safety, survival, public health, conservation, and good citizenship. In your discussion, tell how <a href="/wiki/index.php/Scout_spirit" class="mw-redirect" title="Scout spirit">Scout spirit</a> and the <a href="/wiki/index.php/Scout_Oath" title="Scout Oath">Scout Oath</a> and <a href="/wiki/index.php/Scout_Law" title="Scout Law">Law</a> apply to camping and outdoor ethics.
