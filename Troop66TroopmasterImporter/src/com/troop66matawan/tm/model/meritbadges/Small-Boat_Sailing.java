...
class  Small-Boat_Sailing  extends PartialMeritBadge {
1 Do the following:
...
2 Before doing requirements 3 through 9, successfully complete the <a href="/wiki/index.php/BSA_Swim_Test" class="mw-redirect" title="BSA Swim Test">BSA swimmer test</a>.
...
4 Before going afloat, do the following:
	a. Discuss the nine points of the BSA <a href="/wiki/index.php/Safety_Afloat" title="Safety Afloat">Safety Afloat</a> plan.
...
7 Demonstrate a working knowledge of marlinespike seamanship. Do the following:
	a. Show how to tie a <a href="/wiki/index.php/Square_Knot" class="mw-redirect" title="Square Knot">square (reef) knot</a>, <a href="/wiki/index.php/Clove_hitch" title="Clove hitch">clove hitch</a>, <a href="/wiki/index.php/Two_half_hitches" class="mw-redirect" title="Two half hitches">two half hitches</a>, <a href="/wiki/index.php/Bowline" title="Bowline">bowline</a>, <a href="/wiki/index.php/Cleat_hitch" class="mw-redirect" title="Cleat hitch">cleat hitch</a>, and <a href="/wiki/index.php/Figure-eight" class="mw-redirect" title="Figure-eight">figure-eight</a> knot. Demonstrate the use of each.
